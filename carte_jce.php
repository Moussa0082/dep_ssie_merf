...
$query_act = "SELECT * FROM t_1646237257 WHERE Id=".GetSQLValueString($_GET["print"], "text")." $query_plus";
else
{
if(isset($_GET["commune"]))  $query_act = "SELECT t_1646237257.*, code_commune, nom_commune, departement FROM t_1646237257, commune where nom_commune=col2 $query_plus";
else  $query_act = "SELECT t_1646237257.*, code_commune, nom_commune, departement FROM t_1646237257, commune where nom_commune=col2 and col2=-1";
...
<form name="form<?php echo $annee; ?>" id="form<?php echo $annee; ?>" method="get" action="./carte_jce.php" class="pull-right">
...
// $a = explode('/',$_POST['date_collecte']); $annee = isset($a[2])?$a[2]:date("Y"); 
  ...
  $insertSQL = sprintf("UPDATE t_1646237257 SET col23=%s WHERE Id='$code_gen'", GetSQLValueString($maxcodeind, "text"));
...
<div class="col-md-4">
  <div class="statbox widget box box-shadow">
    <div class="widget-content" style="overflow: hidden;height: 280px;"><a href="#">
...
<?php }else{*/ ?>
      <div class="visual cyan" style="<?php echo (isset($row_act1["col21"]) && file_exists("./fiches/pieces/".$row_act1["col21"]))?"padding:0px;":""; ?>"><img src="<?php  echo (isset($row_act1["col12"]) && file_exists("./fiches/pieces/".$row_act1["col21"]))?"./fiches/pieces/".$row_act1["col12"]:"./images/avatar/none.png"; ?>" width='<?php  echo (isset($row_act1["col21"]) && file_exists("./fiches/pieces/".$row_act1["col12"]))?50:50; ?>' height='<?php  echo (isset($row_act1["col12"]) && file_exists("./fiches/pieces/".$row_act1["col12"]))?50:50; ?>' alt='preview'></div>
        <div class=""><?php echo (isset($row_act1["col14"]))?"JCE: ".$row_act1["col14"]:""; //echo (isset($row_act1["col5"]))?" ".$row_act1["col5"]:""; ?></div>
		 <div class=""><?php echo (isset($row_act1["col5"]))?"Promoteur: ".$row_act1["col5"]:""; ?></div>
      <?php //} ?></a>
      <a href="javascript:void(0);" onclick="printCarte('./carte_jce.php?<?php echo "annee=$annee&print=".$row_act1['Id']; ?>');" title="Imprimer" class="btn-print pull-right donot_print"><img class="graph-image1" src="./images/print.png" ></a>
      <div class="title_fiche">Canton<?php echo (isset($row_act1["col3"]))?" ".$row_act1["col3"]."":""; ?><br /></div>
      <div class="value_fiche"><font size="1">Identifiant : </font><span style="color:#CC0000; font-weight:bold"><?php echo $code_gen; ?></span></div>
      <div class="value_fiche" style="clear: both;"><font size="1">Commune : </font><span style="font-weight:bold"><?php echo (isset($row_act1["nom_commune"]))?$row_act1["nom_commune"]:""; ?></span>&nbsp;&nbsp;Contact: <span style="font-weight:bold"><?php echo (isset($row_act1["col9"]))?$row_act1["col9"]:""; (isset($row_act1["col10"]))?" /".$row_act1["col10"]:""?></span></div>
