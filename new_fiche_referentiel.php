...
if(isset($_GET["id"]) && !empty($_GET["id"]))
{
  ...
  $query_liste_feuille = "SELECT * FROM ".$database_connect_prefix."referentiel_fiche_config WHERE id='$id'";
...
<script>
	$().ready(function() {
        ...
        get_content('menu_feuille_colonne.php','id=<?php echo $row_liste_feuille["feuille"]."&id_s=".$row_liste_feuille["colonneC"]; ?>','colonneC',''); 
        <?php } ?>
	});
</script>
...
<table border="0" id="mtable" align="center" cellspacing="1" cellpadding="0" width="100%" style="font-size:14px;">
    ...
    <tr valign="top">
      <td>
        <div class="form-group">
          ...
          <div class="col-md-9">
            <select name="feuille" id="feuille" class="form-control required" onchange="get_content('menu_feuille_colonne.php','id='+this.value,'colonne',''); get_content('menu_feuille_colonne.php','id='+this.value,'colonneC','');" >
              <option value="">Selectionnez</option>
            </select>
          </div>
        </div>      </td>
  ...
  <tr>
    ...
    <tr valign="top">
      <td>
        <div class="form-group">
          <label for="colonne" class="col-md-3 control-label">Colonne crit&egrave;re </label>
          <div class="col-md-9">
            <select name="colonneC" id="colonneC" class="form-control required" >
              <option value="">Selectionnez</option>
            </select>
          </div>
        </div>      </td>
