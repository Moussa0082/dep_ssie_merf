...
if(!is_dir("backup_sql")) mkdir("backup_sql");
if(!file_exists("./backup_sql/index.php"))
{
  	//create index.php file
	$handle = fopen('./backup_sql/index.php','w+');
    $a = "<?php
///////////////////////////////////////////////
/*                 SSE                       */
/*	Conception & Développement: SEYA SERVICES */
...
<div class="widget-header"> <h4><i class="icon-reorder"></i> Exportation </h4>
...
<a onclick="get_content('new_type_mp.php','','modal-body_add',this.title);" data-toggle="modal" href="#myModal_add" title="Ajout de Type de microprojet" class="pull-right p11"><i class="icon-plus"> Nouveau Type de microprojet </i></a> -->
<?php } ?>
</div>
        ...
        <table width="100%" border="0" align="center" cellspacing="0">
          <tr>
            <td valign="top">              <div align="center">
                ...
                <h1>Exportation des donn&eacute;es du syst&egrave;me</h1>
                <h2 style="color: green"><?php
$yyyymmdd_mmss  = date("Y_m_d_H_i");
$path      = "backup_sql/";
$filename  = $path."RUCHE_PSAC_SAUVEGARDE_".$yyyymmdd_mmss.".zip"; // Filename of dump, default: "dump.php"
$compress  = true; // Dump as a compressed file, default: false

$dump = new phpMyDumper($database_pdar_connexion,$pdar_connexion,$filename,$compress);
