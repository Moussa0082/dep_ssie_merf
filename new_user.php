...
//Projets
 $pf_projet = str_replace("|",",",$_SESSION["clp_user_projet"]);
$query_liste_projet = "SELECT * FROM ".$database_connect_prefix."projet where FIND_IN_SET( code_projet, '".$pf_projet."' ) order by sigle_projet ";
try{
    ...
    <tr>
      <td valign="top">
        <div class="form-group">
          <label for="id" class="col-md-10 control-label">Identifiant <?php //echo $_SESSION["clp_user_projet"]; ?><span class="required">*</span></label>
          <div class="col-md-12">
