...
$idf="id_op";
 ...
 ?>
 <a onclick="get_content('new_op.php','<?php echo "annee=$annee&region="; ?>','modal-body_add',this.title);" data-toggle="modal" href="#myModal_add" data-backdrop="static" data-keyboard="false" title="Nouveau groupement" class="pull-right p11" dir=""><i class="icon-plus"> Ajouter groupement <?php echo $annee; ?>  </i></a>
<?php } ?>
...
<td><strong>
  <span class="Style1">
  <?php  echo "GD=".$row_act['id_op']." V=".$row_act["village"];  ?>
  </span> &nbsp;&nbsp;/
  </strong>
