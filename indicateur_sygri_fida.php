...
if ((isset($_GET["id_sup_ind"]) && intval($_GET["id_sup_ind"])>0)) {
  ...
  $insertSQL = sprintf("DELETE FROM indicateur_sygri_fida WHERE id_indicateur_sygri_fida=%s",
...
if(!empty($_POST['indicateur_simple'])) { foreach($_POST['indicateur_simple'] as $vindicateur_simple) { $indicateur_simple=$indicateur_simple.",".$vindicateur_simple; } }
  ...
  $insertSQL = sprintf("INSERT INTO  indicateur_sygri_fida (intitule_indicateur_sygri_fida, reference, referentiel, ordre, id_personnel, date_enregistrement) VALUES (%s, %s, %s,  %s,'$personnel', '$date')",
...
$insertSQL = sprintf("UPDATE indicateur_sygri_fida SET intitule_indicateur_sygri_fida=%s, reference=%s, referentiel=%s, ordre=%s WHERE id_indicateur_sygri_fida=$id",
...
<a onclick="get_content('new_indicateur_sygri_fida.php','','modal-body_add',this.title);" data-toggle="modal" href="#myModal_add" data-backdrop="static" data-keyboard="false" title="Ajout d'indicateur" class="btn btn-sm btn-warning pull-right p11" dir=""><i class="icon-plus"> Nouvel indicateur </i></a>
...
<a href="sygri_niveau2_projet.php" title="Editer le 2&egrave;me Niveau SYGRI" class="pull-right p11"> SYGRI 2<sup>&egrave;me</sup> Niveau </a>
<a href="sygri_niveau1_projet.php" title="Editer le 1er Niveau SYGRI" class="pull-right p11"> SYGRI 1<sup>er</sup> Niveau </a>
...
<?php
mysql_select_db($database_pdar_connexion, $pdar_connexion);
$query_ind = "SELECT * FROM indicateur_sygri_fida ORDER BY ordre";
...
<td class=" " align="center"><a onclick="get_content('new_indicateur_sygri_fida.php','id=<?php echo $id; ?>','modal-body_add',this.title);" data-toggle="modal" href="#myModal_add" title="Modification d'indicateur" class="thickbox Add"  dir=""><img src="images/edit.png" width='20' height='20' alt='Modifier' /></a></td>
