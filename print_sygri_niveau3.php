...
header("content-disposition: attachment;filename=SYGRI_3eme_Niveau_FIER.xls"); }
else if(isset($_GET["down"]) && isset($_GET["t"]) && $_GET["t"]=="w"){
header("Content-Type: application/vnd.ms-word");
header("Expires: 0");
header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
header("content-disposition: attachment;filename=SYGRI_3eme_Niveau_FIER.rtf"); }
...
$query_liste_indicateur_sygri = "SELECT * FROM indicateur_sygri_fida ORDER BY ordre";
...
<br />
<?php } ?>
<h4 align="center">Indicateurs SYGRI 3<sup>&egrave;me</sup> Niveau du FIER Editer le <?php echo date("d/m/Y"); ?></h4>


<table border="1" align="center" cellspacing="0">
  <tr class="titrecorps2">
    <td><div align="left">&nbsp;<span class="Style50 Style14">Indicateurs</span> &nbsp;</div></td>
    <td><span class="Style50 Style14">Unit&eacute;</span></td>
   
    </tr>
  <?php $t=0; $mt=0; if($totalRows_liste_indicateur_sygri>0) { $p1="j";$t=0; $i=0;do { ?>
  <tr <?php if($i%2==0) echo 'bgcolor="#ECF0DF"';  $t=$t+1; $i=$i+1;?> >
    <td><span class="Style46"><?php echo $row_liste_indicateur_sygri['intitule_indicateur_sygri_fida']; ?></span></td>
    <td><div align="center"><span class="Style46"><?php if(isset($unite_ind_ref_array[$row_liste_indicateur_sygri["referentiel"]])) echo " (".$unite_ind_ref_array[$row_liste_indicateur_sygri["referentiel"]].")"; ?></span></div></td>
   
    </tr>
  <?php } while ($row_liste_indicateur_sygri = mysql_fetch_assoc($liste_indicateur_sygri)); ?>
  <?php } ?>
</table>
