...
//liste region
$query_liste_region = "SELECT *  FROM departement where code_departement!='0'  order by code_departement   asc";
 try{
...
<div class="widget-header"> <h4><i class="icon-reorder"></i> Fiche  d'identification des JCE </h4>
...
// echo do_link("","","Importation depuis un format excel","<i class=\"icon-plus\"> Importer </i>","","./","pull-right p11","get_content('import_fiches_statiques.php','feuille=$feuille&idf=$idf&annee=$annee','modal-body_add',this.title);",1,"margin-top:-5px;",$nfile);?>
  <a onclick="get_content('new_fiche_indentification.php','<?php echo "annee=$annee"; ?>','modal-body_add',this.title);" data-toggle="modal" href="#myModal_add" data-backdrop="static" data-keyboard="false" title="Fiche d'identification des jeunes" class="pull-right p11" dir=""><i class="icon-plus"> Ajout d'un jeune  </i></a>
   <?php
...
<div class="tabbable tabbable-custom" >
  ...
  <?php $j=0; foreach($tab_array as $a=>$b){ ?>
 <div class="tab-pane <?php echo ($j==$annee || $j==0)?"active":""; ?>" id="tab_feed_<?php echo $j; ?>"
      data-target="./fiche_identification_content_jce.php?r=<?php echo $a; ?>" >
