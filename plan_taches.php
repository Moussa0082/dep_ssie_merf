...
<td><div align="center" class="Style31">
  <div align="left"><?php echo $row_liste_zone['intitule_tache']; ?>
    ...
    <?php } ?>
    <?php } else echo "<h3>Aucune t�che saisie</h3>" ;?>
  </table>
...
<div class="widget box">
<div class="widget-header"> <h4><i class="icon-reorder"></i> <?php echo (isset($_GET["id"]) && !empty($_GET["id"]))?"Modification d'�tape":"Nouvelle �tape"; ?></h4>
...
<tr valign="top">
      <td colspan="2">
        <div class="form-group">
          <label for="intitule_tache" class="col-md-12 control-label">Intitul� de la t�che <span class="required">*</span></label>
          <div class="col-md-12">
