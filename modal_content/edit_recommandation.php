...
<option value="Immédiat"<?php if(isset($_GET['id'])){if (!(strcmp("Immédiat", $row_liste_activite['type']))) {echo "SELECTED";}} ?>>Immédiat</option>
<option value="Immédiat et Continu"<?php if(isset($_GET['id'])){if (!(strcmp("Immédiat et Continu", $row_liste_activite['type']))) {echo "SELECTED";}} ?>>Immédiat et Continu</option>
