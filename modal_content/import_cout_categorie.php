    ...
    if(in_array($ext,$extensions_autorisees))
    {
      ...
      elseif(isset($_FILES['fichier']) && $_FILES['fichier']['error'] == 0)
      {
       ...
       // if(isset($_POST["erase"]) && $_POST["erase"]==1)
        //{
          $query_sup_import_annee = "DELETE FROM code_categorie WHERE annee=$annee and projet='".$_SESSION["clp_projet"]."' and structure='".$_POST["crp"]."'";	  
		    try{
...
$insertSQL="INSERT INTO code_categorie (code, libelle, cout_realise , cout_engage, cout_prevu, annee, structure, projet) VALUES ('".trim($rowData[0][0])."',".GetSQLValueString(trim(utf8_encode($rowData[0][1])),"text").",'".str_replace(" ","",$rowData[0][2])."', '".str_replace(" ","",$rowData[0][3])."', '".str_replace(" ","",$rowData[0][5])."','".$annee."', '".$_POST["crp"]."', '".$_SESSION["clp_projet"]."')";
		    try{
    ...
    $Result1->execute();
          ...
          {
$insertSQL="INSERT INTO code_categorie (code, libelle, cout_realise , cout_engage, cout_prevu, annee, structure, projet) VALUES ('fichiers','$inputFileName',0, 0, 0,'".$annee."', '".$_POST["crp"]."', '".$_SESSION["clp_projet"]."')";
		    try{
