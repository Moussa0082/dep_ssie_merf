    ...
    if(in_array($ext,$extensions_autorisees))
    {
      ...
      elseif(isset($_FILES['fichier']) && $_FILES['fichier']['error'] == 0)
      {
       ...
       // if(isset($_POST["erase"]) && $_POST["erase"]==1)
        //{
          $query_sup_import_annee = "DELETE FROM code_activite WHERE annee=$annee and projet='".$_SESSION["clp_projet"]."' and structure='".$_POST["crp"]."'";	  
		    try{
...
$query_nbr_car = "SELECT libelle,code_number FROM niveau_config WHERE projet='".$_SESSION["clp_projet"]."' LIMIT 1";
  try{
...
$insertSQL="INSERT INTO code_activite (code, libelle, cout_realise , cout_engage, cout_prevu, annee, structure, projet) VALUES ('".trim($rowData[0][0])."',".GetSQLValueString(trim($rowData[0][1]),"text").",'".doubleval($rowData[0][4])."', 0, '".doubleval($rowData[0][5])."','".$annee."', '".$_POST["crp"]."', '".$_SESSION["clp_projet"]."')";
		    try{
    ...
    $Result1->execute();
          ...
          {
$insertSQL="INSERT INTO code_activite (code, libelle, cout_realise , cout_engage, cout_prevu, annee, structure, projet) VALUES ('fichiers','$inputFileName',0, 0, 0,'".$annee."', '".$_POST["crp"]."', '".$_SESSION["clp_projet"]."')";
		    try{
...
<div class="widget-header"> <h4><i class="icon-reorder"></i><?php if(isset($_GET['id'])) echo "Joindre le ficher &agrave; importer"; else echo "Joindre le ficher &agrave; importer" ; ?></h4></div>
<div class="widget-content">
                    ...
                    <form action="" method="post" name="form1" id="form1"   enctype="multipart/form-data">
                      ...
                      <div id="special">
                        ...
                        <table align="center">
     <tr valign="baseline">
                            <td align="right" valign="top" nowrap="nowrap"><strong>Site&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>
	...
	<br /><br />
					...
					<div align="center" class="Style3" style="background-color:#66CC00; color:#FFFFFF">Importation termin&eacute;e avec succ&egrave;s.<br /> Vous pouvez fermer cette f&eacute;n&ecirc;tre</div>
					<?php } ?>
</div>
</div>
</body>
