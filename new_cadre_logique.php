...
{
  $id=($_GET["id"]);
  $query_liste_activite = "SELECT * FROM ".$database_connect_prefix."cadre_logique WHERE code='$id' and projet='".$_SESSION["clp_projet"]."'";
        	try{
...
<?php if(($type[$niveau-1])==1){ //produit
  ...
  $query_liste_volet = "SELECT * FROM ".$database_connect_prefix."activite_projet WHERE projet='".$_SESSION["clp_projet"]."' and niveau=1 ORDER BY code ASC";
            	try{
    ...
    <tr valign="top">
      <td>
        <div class="form-group">
          <label for="parent" class="col-md-3 control-label"><?php echo (isset($libelle1[0]) && !empty($libelle1[0]))?$libelle1[0]:"Niveau"; ?> <span class="required">*</span></label>
          <div class="col-md-9">
