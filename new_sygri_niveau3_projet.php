...
$query_edit_data = "SELECT * FROM indicateur_sygri3_projet where id_indicateur_sygri_niveau3_projet='$id'";
...
mysql_select_db($database_pdar_connexion, $pdar_connexion);
$query_liste_sygri = "SELECT * FROM liste_indicateur_sygri where id_indicateur_sygri_fida not in (select id_sygri from indicateur_sygri1_projet where id_indicateur_sygri_niveau1_projet!=$id and projet='".$_SESSION["clp_projet"]."') and niveau_sygri=3";
...
<table border="0" id="mtable" align="center" cellspacing="1" cellpadding="0" width="100%" style="font-size:14px;">
 ...
 <tr valign="top">
   ...
   <tr valign="top">
      <td colspan="2">
        <div class="form-group">
          <label for="cible" class="col-md-3 control-label">Objectif <span class="required">*</span></label>
          <div class="col-md-9">
