...
<?php
if($totalRows_entete>0){ $j=0; do{  if($row_entete["Field"]!="LKEY" && in_array($row_entete["Field"],$entete_array) && $i>0){
 ?>
<td class=" "><?php
...
<?php }
 } else { $colspan = ($colnum==1)?$i+1:$i; echo "</table><table><tr><td colspan='".($colspan+1)."' class='' align='center'><h3 align='center'>Aucune donn&eacute;es &agrave; afficher dans cette feuille !</h3></td></tr>"; } ?>
</table><?php }else echo "<h3 align='center'>Aucune colonne &agrave; afficher dans la fiche ".$lib_nom_fich."!</h3>"; ?>
