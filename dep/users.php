...
//personnel
//$niveau_array = {0,3,4};
$query_personnel = "SELECT * FROM ".$database_connect_prefix."personnel where niveau IN(0,3,4) or id_personnel='admin' ORDER BY date_enregistrement desc ";
try{
    $personnel = $pdar_connexion->prepare($query_personnel);
    $personnel->execute();
...
$liste_niveau_array = array('Point focal','Aucun','Aucun','Strategique','Responsable');
