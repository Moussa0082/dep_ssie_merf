...
if(isset($_GET['niveau']) && intval($_GET['niveau'])>0) { $niveau=intval($_GET['niveau']); } else {$niveau;$_GET['niveau']=1;}
$where = " niveau = ".($niveau)." ";
    ...
    <tr valign="top">
      <td>
        <div class="form-group">
          <label for="parent" class="col-md-3 control-label"><?php echo (isset($libelle1[$niveau-2]) && !empty($libelle1[$niveau-2]))?$libelle1[$niveau-2]:"Niveau"; ?> <span class="required">*</span></label>
          <div class="col-md-9">
