...
$query_liste_groupes_travail = "SELECT id_projet, code_projet, sigle_projet,annee_debut, annee_fin, ugl FROM mtz.projet order by annee_debut";
 try{
...
$query_liste_periode = "SELECT sum(cout_realise) as cout, code_activite.projet FROM mtz.code_activite WHERE code!='Code' and code!='fichiers' group by projet";	
 try{
...
$query_liste_type_reunion = "SELECT sum(montant) as cout, projet FROM pnf.partenaire, mtz.type_part WHERE code=bailleur  GROUP BY projet";
 try{
...
<tr role="row">
  ...
  <th colspan="3" data-hide="phone,tablet"><div align="center">Budget (F CFA) </div></th>
  </tr>
<tr role="row">
