...
$query_projet_cout = $db ->prepare('SELECT sum(montant) as montant, programme FROM t_repartition_projet_budget, t_projets where id_projet=projet_bud group by projet_bud');
