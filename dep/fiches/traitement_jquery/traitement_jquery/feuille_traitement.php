...
$Structure_Champs="";
$Structure_Table="";
$Structure_View="CREATE VIEW $Nom_View AS SELECT Id AS Id, Stat AS Stat, Date_Insertion AS Date_Insertion, ";
...
switch ($type_Ligne[$i]) {
	...
	$ui=0;
	$Table_Choix=explode(';', $valeur[$i]);
	foreach ($Table_Choix as $k2) {$ui++; $Structure_View.='col'.array_search(trim($k2), $nom_Ligne).'+';}
	$Structure_View=substr($Structure_View, 0, strlen($Structure_View)-1);
...
$Structure_Table='CREATE TABLE '.$Nom_Table.'(Id BIGINT(20) AUTO_INCREMENT PRIMARY KEY, Stat INT(1) DEFAULT 0, Date_Insertion DATETIME DEFAULT CURRENT_TIMESTAMP, ';
