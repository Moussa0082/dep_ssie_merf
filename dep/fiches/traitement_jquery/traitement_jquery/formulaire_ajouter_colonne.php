...
<div id="formulaire_ajouter_colone_conteneur">
';
$Compte=0;
...
echo '<div class=" div_ligne_feuille" id="div_ligne_feuille_1">
                              <div class="row">
                                <div class="col-sm-2 col-md-2 mb-2">
                                 <input type="text" class="form-control" required placeholder="Nom Colonne " name="nom_Ligne[]" id="nom_Ligne[]">
                                </div>
                                <div class="col-sm-2 col-md-1.5 mb-2">
                                  <input type="text" class="form-control" required placeholder="Libelle" name="libelle_Ligne[]" id="libelle_Ligne[]">
                                </div>
