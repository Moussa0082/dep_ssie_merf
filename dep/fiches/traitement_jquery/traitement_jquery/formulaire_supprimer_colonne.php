...
<div class="col-sm-4 col-md-4 mb-4"><textarea required class="form-control" placeholder="Libelle" name="Libelle_Feuille" id="Libelle_Feuille" readonly>'.$row4['Libelle_Feuille'].'</textarea></div><input type="hidden" name="Code_Classeur" value="'.base64_decode($classeur).'"><div class="col-sm-1 col-md-1 mb-1"></div></div><br><div class="row">
<div class="col-sm-1 col-md-1 mb-1"></div>
<div class="col-sm-2 col-md-2 mb-2"><label> Nom Colonne </label></div><div class="col-sm-2 col-md-1.5 mb-2"><label> Libelle Colonne </label></div><div class="col-sm-2 col-md-2 mb-2"><label> Type Colonne </label></div><div class="col-sm-2 col-md-2 mb-2"><label > Requis </label></div><div class="col-sm-2 col-md-2 mb-2"><label > Afficher</label></div><div class="col-sm-1 col-md-1 mb-1"></div></div>';
$Compte=0;
...
<input type="checkbox" class="form-control" name="CheckBox_Delete_Colonne[]" value="'.$row5['Nom_Collone'].'">
</div></div>
