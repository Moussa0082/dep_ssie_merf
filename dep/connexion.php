...
///////////////////////////////////////////////
  ...
  if(isset($_POST['identifiant']) && isset($_POST['password']))
  {
    ...
    {
//$niveau_array = array('Point focal','Aucun','Aucun','Strategique','Responsable');
    $query_clp = "SELECT * FROM ".$database_connect_prefix."personnel WHERE id_personnel="."'$l' AND pass="."'$p' and (niveau IN(0,3,4) or id_personnel='admin')";
    try{
