...
<div class="widget-header"> <h4><i class="icon-reorder"></i> Listes des unités de gestion</h4>
...
echo do_link("","","Ajout d'unit&eacute; de gestion","<i class=\"icon-plus\"> Nouvel UG </i>","","./","pull-right p11","get_content('new_ugl.php','','modal-body_add',this.title);",1,"",$nfile);
?>
<?php } ?>
</div>
...
<td class=" ">&nbsp;
  <b>
  <?php if(isset($row_liste_ugl["region_concerne"]) && $row_liste_ugl["region_concerne"]!="|" && $row_liste_ugl["region_concerne"]!="") {$a = explode("|",$row_liste_ugl["region_concerne"]); if(isset($a) && sizeof($a)>0){   $c[]=do_link("","","Edition de la zone d'intervention $ab ","<span title=\""."Edition des communes "."\">".(sizeof($a)-1)." communes</span>","","./","","get_content('new_region_ugl.php','id=$code&sigleu=$sigleu','modal-body_add',this.title);",1,"margin:0px 5px;",$nfile); echo implode('; &nbsp;',$c); }} else { $c[]=do_link("","","Edition de la zone d'intervention $ab ","<span title=\"Edition des communes\">Editer</span>","","./","","get_content('new_region_ugl.php','id=$code&sigleu=$sigleu','modal-body_add',this.title);",1,"margin:0px 5px;",$nfile); echo implode('; &nbsp;',$c); } ?>
...
<?php
echo do_link("","","Modifier ugl ".$row_liste_ugl['nom_ugl'],"","edit","./","","get_content('new_ugl.php','id=$id','modal-body_add',this.title);",1,"margin:0px 5px;",$nfile);

echo do_link("",$_SERVER['PHP_SELF']."?id_sup=".$id,"Supprimer","","del","./","","return confirm('Voulez-vous vraiment supprimer cet ugl ".$row_liste_ugl['nom_ugl']."');",0,"margin:0px 5px;",$nfile);
?></td>
<?php } ?>
</tr>
<?php } } ?>
