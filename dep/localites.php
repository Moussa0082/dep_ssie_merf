...
<?php echo do_link("","./localites.php?niveau=3","Cantons","Cantons","","./","pull-right p11","",0,"",$nfile); ?>
...
<?php if(isset($_SESSION['clp_niveau']) /*&& $_SESSION['clp_niveau']==1*/){ ?>
                    ...
                    echo do_link("","","Modifier ".$libelle[$niveau],"","edit","./","","get_content('new_localite.php','id=$code&niveau=".($niveau)."','modal-body_add',this.title);",1,"margin:0px 5px;",$nfile);
