...
/*
    ...
    $config->user = "c0dep";
    $config->password = '9wov6(/3!P_5mYMa';
    $config->db_name = "c0ssi4627";
    $config->db_prefix = "";*/	    $config->host = "localhost";    $config->user = "root";    $config->password = '';    $config->db_name = "c0ssi4627";    $config->db_prefix = "";
    // $config->db_prefix = "";*/	    $config->host = "localhost";    $config->user = "c0ssi4627";    $config->password = 'B$Ji*mWyKfln_';    $config->db_name = "c0ssi4627";    $config->db_prefix = "";
    try
    {
