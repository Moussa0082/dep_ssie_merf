...
if(!class_exists('Config')){
    ...
    $MENU = array(
    1 =>array("localites.php"=>"Localités",/*"unite_gestion.php"=>"Entités de gestion",*/"projets.php"=>"Projets","fonctions.php"=>"Fonction","users.php"=>array("users.php"=>"Utilisateurs","fonctions.php"=>"Fonction"),"partenaires.php"=>"Acteurs clés","projets.php"=>"Projets MERF","bailleurs.php"=>"Bailleurs","autres_parametres.php"=>"Autres paramètres"),
    2 => array("referentiel.php"=>"Indicateurs reférentiels","fiche_projets.php"=>"Fiche des projets","fiches_dynamiques.php"=>"Fiches dynamiques")/*,
    3 => array("liste_convention.php"=>"Conventions cadres","plan_ptba.php"=>"PTBA","suivi_indicateur_ptba.php"=>"Suivi du PTBA","plan_marche.php"=>"PPM","analyse_budgetaire.php"=>"Analyse budgetaire","gestion_contrat_prestation.php"=>"Contrats de prestation","gestion_decompte.php"=>"Décomptes"),
