...
if(!class_exists('Config')){
    ...
    2 => array("referentiel.php"=>"Indicateurs reférentiels","niveau_i3n.php"=>"Niveaux sectoriel","indicateur_i3n.php"=>"Indicateurs sectoriels","niveau_cosop.php"=>"Cadre analytique","indicateur_cosop.php"=>"Indicateurs analytique","fiches_dynamiques.php"=>"Fiches dynamiques"),
