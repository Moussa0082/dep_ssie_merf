 ...
 */
(function(d){ColVis=function(a,b){(!this.CLASS||"ColVis"!=this.CLASS)&&alert("Warning: ColVis must be initialised with the keyword 'new'");"undefined"==typeof b&&(b={});this.s={dt:null,oInit:b,fnStateChange:null,activate:"click",sAlign:"left",buttonText:"Colonnes <i class='icon-angle-down'></i>",hidden:!0,aiExclude:[],abOriginal:[],bShowAll:!0,sShowAll:"Tout afficher",bRestore:!1,sRestore:"Ré-initialiser",iOverlayFade:500,fnLabel:null,sSize:"auto",bCssPosition:!1};this.dom={wrapper:null,button:null,collection:null,background:null,
