...
//Partenaire
//Acteurs
$query_liste_acteur = "SELECT * FROM ".$database_connect_prefix."acteur order by nom_acteur ";
try{
...
//Projets
$query_liste_projet = "SELECT * FROM ".$database_connect_prefix."projet order by sigle_projet ";
try{
...
<table border="0" align="center" cellspacing="1" cellpadding="0" width="100%" style="font-size:14px;">
    ...
    <tr>
      <td colspan="2" valign="top">	   <div class="form-group">
          <label for="projet_concerne" class="col-md-10 control-label">Projets <span class="required">*</span></label>
          <div class="col-md-12">
            <select name="projet_concerne[]" id="projet_concerne" class="full-width-fix select2-select-00 required" data-placeholder="S&eacute;lectionnez un projet" multiple>
              <option></option>
              <option value="">Aucun</option>
               <?php if($totalRows_liste_projet>0) {  $expl = (isset($row_liste_personnel["projet"]) && !empty($row_liste_personnel["projet"]))?explode('|',$row_liste_personnel["projet"]):array(); foreach($row_liste_projet as $row_liste_projet){ ?>
              <option value="<?php echo $row_liste_projet['code_projet']; ?>" <?php if(in_array($row_liste_projet['code_projet'],$expl)) {echo "SELECTED";} ?>><?php echo $row_liste_projet['sigle_projet']; ?></option>
                <?php  } } ?>
            </select>
          </div>
        </div> </td>
  ...
  <!--    <tr>
    <td valign="top">
        <div class="form-group">
          ...
          <div class="col-md-11">
            <select name="structure" id="structure" class="form-control" onchange="get_content('menu_projet.php','id='+this.value+'<?php //echo (isset($_GET["id"]) && intval($_GET["id"])>0)?"id_s=".$row_liste_personnel['projet']:''; ?>','projet_id','');">
            <option value="">Selectionnez</option>
      <?php /*foreach($row_structure as $row_structure){ ?>
              <option value="<?php echo $row_structure['code_structure']; ?>" <?php if($row_liste_personnel['structure']==$row_structure['code_structure']) echo 'selected="selected"'; ?>><?php echo $row_structure['nom_structure']; ?></option> <?php }*/  ?>
            </select>
          </div>
        </div>
    </td>
      <td valign="top" colspan="2">
        <div class="form-group">
          <label for="projet" class="col-md-10 control-label">Projets </label>
          <div class="col-md-12" id="projet_id">
          </div>
        </div>
    </td>
    </tr>-->
    <tr>
      <td valign="top">
        <div class="form-group">
          <label for="structure" class="col-md-10 control-label">Zones/Unit&eacute; de gestion  <span class="required">*</span></label>
          <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <div class="col-md-12">
            <select name="niveau" id="niveau" class="form-control required" >
              <option value="0" <?php if (isset($row_liste_personnel['niveau']) && !(strcmp("0", $row_liste_personnel['niveau']))) {echo "SELECTED";}  ?>>Point focal</option>
            <!--   <option value="1" <?php //if (isset($row_liste_personnel['niveau']) && !(strcmp("1", $row_liste_personnel['niveau']))) {echo "SELECTED";}  ?>>Edition</option>-->
			  <option value="3" <?php if (isset($row_liste_personnel['niveau']) && !(strcmp("3", $row_liste_personnel['niveau']))) {echo "SELECTED";}  ?>>Strategique</option>
            </select>
          </div>
        </div>    </td>
    </tr>
    <tr>
      <td valign="top"> <div class="form-group">
          <label for="partenaire" class="col-md-10 control-label">Structure/partenaires <span class="required">*</span></label>
          <div class="col-md-11">
            <select name="partenaire" id="partenaire" class="form-control required">
            <option value="0">Selectionnez</option>
      <?php  foreach($row_liste_acteur as $row_liste_acteur){ ?>
              <option value="<?php echo $row_liste_acteur['code_acteur']; ?>" <?php if($row_liste_personnel['partenaire']==$row_liste_acteur['code_acteur']) echo 'selected="selected"'; ?>><?php echo $row_liste_acteur['nom_acteur']; ?></option> <?php } ?>
            </select>
          </div>
        </div>  </td>
      <td valign="top"><div class="form-group">
