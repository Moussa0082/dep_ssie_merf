...
<table class="table table-striped table-bordered table-hover table-responsive  table-colvis datatable dataTable hide_befor_load" id="DataTables_Table" aria-describedby="DataTables_Table_0_info">
<thead>
<tr role="row">
...
<!--<td class=" "><?php if(isset($row_liste_composante['type_ref_ind']) &&  $row_liste_composante['type_ref_ind']==1) echo "produit"; elseif(isset($row_liste_composante['type_ref_ind']) &&  $row_liste_composante['type_ref_ind']==2) echo "Effet"; elseif(isset($row_liste_composante['type_ref_ind']) &&  $row_liste_composante['type_ref_ind']==3) echo "Impact"; ?></td>-->
<td class=" "><?php  if(isset($row_liste_composante['mode_suivi']) &&  $row_liste_composante['mode_suivi']==1) echo "Fiches";  elseif(isset($row_liste_composante['mode_suivi']) &&  $row_liste_composante['mode_suivi']==2) echo "Rapports"; else "ND"; ?></td>
...
<?php echo $row_liste_composante['mode_calcul'];
                     ...
                     <?php } else {?>
                    <?php echo $row_liste_composante['mode_calcul']; ?>
					 <?php if(isset($liste_indicateur_simple_array[$row_liste_composante['id_ref_ind']])) echo " (".substr($liste_indicateur_simple_array[$row_liste_composante['id_ref_ind']],0,strlen($liste_indicateur_simple_array[$row_liste_composante['id_ref_ind']])-1).")"; ?>
