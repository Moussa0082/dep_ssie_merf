...
{
case 'FEUILLE': case 'CHOIX': case 'SOMME': case 'DIFFERENCE': case 'PRODUIT': case 'RAPPORT': case 'MOYENNE': case 'CHOIX MULTIPLES':
  $Valeur="";
...
<textarea type="text" class="form-control" required placeholder="Nom Colonne" name="nom_Ligne[]" id="nom_Ligne[]" value="'.$row5['Nom_Ligne'].'">'.$row5['Nom_Ligne'].'</textarea></div><div class="col-sm-2 col-md-1.5 mb-2"><textarea type="text" class="form-control" required placeholder="Libelle" name="libelle_Ligne[]" id="libelle_Ligne[]" value="'.$row5['Libelle_Ligne'].'">'.$row5['Libelle_Ligne'].'</textarea></div><div class="col-sm-2 col-md-2 mb-2"><select class="form-control" onchange="Charger_Div2(this.value, \''.$Compte.'\')" required name="type_Ligne[]" id="type_Ligne[]">';
