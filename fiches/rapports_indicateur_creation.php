...
<form id="form_rapport_dynamique" action="traitement_jquery\inserer_rapport_indicateur.php" method="POST">
   ...
   <div class="row" style="">
      <div class="col-md-4 col-lg-4">
        <label style="float: left;">Indicateur</label>
    ...
    <div class="col-md-4 col-lg-4">
        ...
        <select class="form-control" name="affichage" id="affichage">
          <option value="Membre du projet">Membre du projet</option>
...
/*for(i=0; i<champ_criteres.length; i++)
  ...
  $.ajax({url:"traitement_jquery/inserer_rapport_indicateur.php", method:"POST", data:$('#form_rapport_dynamique').serialize(), success:function (data) {  
