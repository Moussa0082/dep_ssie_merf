...
$query_liste_activite = $db ->prepare('SELECT code,intitule, categorie_depense, budget_activite FROM t_cadre_resultat WHERE niveau=:niveau and projet=:projet order by code asc');
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td class="text-right">Avancement                                                               </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <?php if($row_liste_activite1["budget_activite"]>0) echo $row_liste_activite1["budget_activite"]; ?>
                                </a></div></td>
                                <td>
                                   <div align="right">
                                ...
                                <td class="text-right">
                 <button class="btn btn-default btn-xs"> <?php if(isset($tableauTache[$row_liste_activite1["code"]])) echo "<strong>".$tableauTache[$row_liste_activite1["code"]]." %</strong>";?></button>                                </td>
                            </tr>
							<?php }} ?>
                            </tbody>
                        </table>
