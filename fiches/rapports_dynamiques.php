...
$("#mbreadcrumb").html(<?php $link = ""; if(isset($_SESSION['clp_niveau']) && $_SESSION['clp_niveau']==0){ if(isset($_SESSION['clp_niveau']) && $_SESSION['clp_niveau']==0) $link .= '<div class="btn-circle-zone">'/*.do_link("btn_rapport","./rapports_dynamiques_creation.php","Création de rapport","<span title='Créer un nouveau rapport' class='glyphicon glyphicon-plus'></span>","simple","./","btn btn-success btn-circle mgr-5","",1,"",$nfile)*/;
