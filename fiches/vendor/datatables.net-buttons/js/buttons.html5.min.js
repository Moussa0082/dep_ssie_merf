...
text:function(a){return a.i18n("buttons.copy","Copy")},action:function(a,b,e,c){var a=C(b,c),d=a.str,e=g("<div/>").css({height:1,width:1,overflow:"hidden",position:"fixed",top:0,left:0});c.customize&&(d=c.customize(d,c));c=g("<textarea readonly/>").val(d).appendTo(e);if(f.queryCommandSupported("copy")){e.appendTo("body");c[0].focus();c[0].select();try{f.execCommand("copy");e.remove();b.buttons.info(b.i18n("buttons.copyTitle","Copier dans la presse-papier"),b.i18n("buttons.copySuccess",{1:"Copié une ligne dans la presse-papier",
_:"%d ligne(s) copiée(s) dans la presse-papiers"},a.rows),2E3);return}catch(i){}}a=g("<span>"+b.i18n("buttons.copyKeys","Appuyez sur <i>ctrl</i> ou <i>⌘</i> + <i>C</i> pour copier les données du tableau <br> dans la Presse-papiers de votre système.<br><br>Pour annuler, cliquez sur ce message ou appuyez sur échap.")+"</span>").append(e);b.buttons.info(b.i18n("buttons.copyTitle","Copier dans la presse-papier"),a,0);c[0].focus();c[0].select();var h=g(a).closest(".dt-button-info"),m=function(){h.off("click.buttons-copy");g(f).off(".buttons-copy");b.buttons.info(!1)};h.on("click.buttons-copy",
