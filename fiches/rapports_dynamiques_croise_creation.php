...
<script>
$("#search").hide();
$("#mbreadcrumb").html(<?php $link = ""; if(isset($_SESSION['clp_niveau']) && $_SESSION['clp_niveau']==0){ if(isset($_SESSION['clp_niveau']) && $_SESSION['clp_niveau']==0) $link .= '<div class="btn-circle-zone">'.do_link("btn_rapport","#myModal","Enregistrer ce rapport","<span title='Enregistrer ce rapport' class='glyphicon glyphicon-ok'></span>","simple","./","btn btn-success btn-circle mgr-5","",1,"",$nfile);
$link .= '</div>';
