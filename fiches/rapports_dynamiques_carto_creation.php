...
<form id="form_rapport_dynamique" action="traitement_jquery\inserer_rapport_croise.php" method="POST">
   ...
   <div class="row" style="">
      ...
      <div class="col-md-4 col-lg-4">
         <button style="width: 150px" type="button" id="Boutton_Ajouter_Critere" disabled <?php echo 'class="btn '.$Boutton_Style.'"'; ?>>Ajouter un critère</button><br><br>
         <label style="text-align: left;">Element en Colonne (Label des points GPS)</label>
   ...
   <div class="row" style="">
      ...
      {echo '<option value="'.$row3["Code_Classeur"].'">'.$row3["Libelle_Classeur"].'</option>';
            ...
            <div class="col-md-6 col-lg-6">
                <label style="float: left;">Feuille 1 (Fiche contenant les données)</label>
                <select class="form-control" name="select_feuille" id="select_feuille">
      
    </select>
            </div> 
            <div class="col-md-6 col-lg-6">
                <label style="float: left;">Feuille 2 (Fiche contenant les coordonnées GPS)</label>
        <select id="feuille_jointure" name="feuille_jointure" class="form-control" disabled></select> 
            ...
            <div class="col-md-6 col-lg-6">
                ...
                <select name="attribut_jointure_fp" id="attribut_jointure_fp"  class="form-control" required disabled></select>
            </div> 
            <div class="col-md-6 col-lg-6">
                <label style="float: left;">Colonne à lier</label>
<select name="attribut_jointure_fs" id="attribut_jointure_fs"  class="form-control" required disabled></select>
            </div>  
         </div> 
      </div>
      <div class="col-md-4 col-lg-4">
        <label style="float: left;">Element en Ligne (Métadonnées)</label>
             <select name="colonne_y" id="colonne_y" class="form-control"></select>
         <label style="float: left;"> Colonne de valeur</label>
         <select name="input_valeur" id="input_valeur" class="form-control"></select>
...
document.getElementById("feuille_jointure").value="";
  if(document.getElementById("select_feuille").value!="")
    ...
    if(data!='')
    {$("#colonne_x").html(data); $("#colonne_y").html(data); $("#input_valeur").html(data);  $("#attribut_jointure_fp").html(data); 
...
/*for(i=0; i<champ_criteres.length; i++)
  ...
  $.ajax({url:"traitement_jquery/inserer_rapport_croise.php", method:"POST", data:$('#form_rapport_dynamique').serialize(), success:function (data) {
