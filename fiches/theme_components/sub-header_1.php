...
if(isset($_SESSION["id"]))
{
  function print_menu_position($nfile,$MENU,$MENU_TITLE)
  {
    ...
    elseif(is_array($MENU))
    {
      ...
      $resultat .= ($t==0)?'<li class=""><span><i class="fa fa-home"></i> <a href="./" title="">Accueil</a> </span></li><li> <i class="fa fa-'.$MENU_TITLE[$id[1]][1].'"></i> <a href="./'.$MENU_TITLE[$id[1]][2].'">'.$MENU_TITLE[$id[1]][0].'</a> </li> <li class="active"> <span>'.$nomc.'</span> </li>':'<li class=""><span><i class="fa fa-home"></i> <a href="./" title="">Accueil</a> </span></li><li> <i class="fa fa-'.$MENU_TITLE[$id[1]][1].'"></i> <a href="./'.$MENU_TITLE[$id[1]][2].'">'.$MENU_TITLE[$id[1]][0].'</a> </li> <li class="active"><span>'.$nomc.'</span> </li>';
    }
    if($te==0)
    {
...
<div class="small-header">
    <div class="hpanel">
        ...
        <div class="label label-<?php echo (isset($_SESSION["projet"]) && !empty($_SESSION["projet"]))?"success":"danger"; ?>" style="display: block;font-weight: normal;border-radius: unset;"><?php echo (isset($_SESSION["projet"]) && !empty($_SESSION["projet"]))?"Programme/Projet : ".$_SESSION["projet_nom"]." (<b>".$_SESSION["programme_sigle"]."/".$_SESSION["projet_sigle"]."</b>)":"Veuillez s&eacute;lectionner un Projet"; ?></div>
    </div>
</div>
<?php } ?>