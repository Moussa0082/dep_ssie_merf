...
$("#mbreadcrumb").html(<?php $link = ""; if(isset($_SESSION['niveau']) && $_SESSION['niveau']<2){ if(isset($_SESSION['niveau']) && $_SESSION['niveau']<2) $link .= '<div class="btn-circle-zone">'.do_link("btn_classeur","#add_classeur_modal","Ajout de classeur","<span title='Nouveau classeur' class='glyphicon glyphicon-plus'></span>","simple","./","btn btn-success btn-circle mgr-5","",1,"",$nfile);
$link .= '</div>';
...
$ii=0;
$ui=0;
$Id_Projet=(isset($_SESSION['projet']) AND !empty($_SESSION['projet']))?$_SESSION['projet']:"NULL";
