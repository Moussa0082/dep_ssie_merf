...
document.getElementById("feuille_jointure").value="";
  if(document.getElementById("select_feuille").value!="")
    ...
    if(data!='')
    {$("#input_regrouper_par").html(data); $("#input_valeur").html(data);  $("#attribut_jointure_fp").html(data); 
...
/*for(i=0; i<champ_criteres.length; i++)
  ...
  $.ajax({url:"traitement_jquery/inserer_rapport_simple.php?action=modif", method:"POST", data:$('#form_rapport_dynamique').serialize(), success:function (data) {
