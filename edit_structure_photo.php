...
<div class="widget-header"> <h4><i class="icon-reorder"></i> <?php echo (isset($_GET["id"]) && intval($_GET["id"])>0)?"Modification photo de la structure":"Nouvelle photo de structure"?></h4> </div>
    ...
    <tr>
      <td valign="top">
        <div class="form-group">
          ...
          <div class="col-md-9">
          <div id="photo_prev">
          <?php if(isset($_GET["id"]) && intval($_GET["id"])>0 && file_exists("./images/structure/img_".($_GET["code"]).".jpg")) { ?>
          <img src="<?php echo "./images/structure/img_".($_GET["code"]).".jpg"; ?>" width='160' height='160' alt='preview'>
          <?php } ?>
          </div>
