...
<head>
  ...
  <link href="<?php print $config->theme_folder;?>/flexslider.css" rel="stylesheet" type="text/css"/>
  ...
  <script type="text/javascript" src="<?php print $config->script_folder;?>/jquery.flexslider-min.js"></script>
...
<!--
 ...
 <script src="<?php print $config->script_folder; ?>/modules/wordcloud.js"></script>
...
<div id="container" class="<?php echo (isset ($_SESSION["clp_id"]))?"":"sidebar-closed"; ?>">
...
<?php
if (isset ($_SESSION["clp_id"])) {
    /*if(isset($_SESSION['clp_niveau']) && $_SESSION['clp_niveau']!=1) include_once "accueil_stp.php"; else*/ include_once "accueil.php";
}
else {
  include ("login.php");
}
