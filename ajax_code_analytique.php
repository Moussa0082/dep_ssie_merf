...
{  */
  ...
  mysql_select_db($database_pdar_connexion, $pdar_connexion);
  $query_liste_activite_1 = "SELECT * FROM ".$database_connect_prefix."activite_projet WHERE $where and projet='".$_SESSION["clp_projet"]."'  and code not in (select code_activite_ptba from ".$database_connect_prefix."ptba where annee=$annee and projet='".$_SESSION["clp_projet"]."')";
