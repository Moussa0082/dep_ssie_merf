...
{
  $id=intval($_GET["id"]);
  $query_liste_iog = "SELECT * FROM indicateur_objectif_specifique WHERE id_indicateur_objectif_specifique=$id ";
try{
...
<div class="widget-header"> <h4><i class="icon-reorder"></i> <?php echo (isset($_GET["id"]) && intval($_GET["id"])>0)?"Modification":"Nouvel"; echo " Indicateur Objectif Sp&eacute;cifique";?></h4> </div>
<div class="widget-content">
<form action="" class="form-horizontal3 row-border" method="post" enctype="multipart/form-data" name="form6" id="form6" novalidate="novalidate">
    ...
    <tr valign="top">
      <td colspan="3">
        <div class="form-group">
          ...
          <div class="col-md-9">
            <input class="form-control required" type="text" name="code" id="code" value="<?php if(isset($_GET["id"]) && intval($_GET["id"])>0) echo $row_liste_iog['code_ios']; ?>" size="32" />
          </div>
        </div>      </td>
    </tr>
    <tr valign="top">
        ...
        <div class="form-group">
          ...
          <div class="col-md-9">
            <select name="objectif" id="objectif" class="form-control required" onchange="get_content('menu_cercle.php','id='+this.value,'cercle','');" >
              ...
              <option value="<?php echo $row_liste_os['id_objectif_specifique']; ?>" <?php if(isset($_GET["id"]) && intval($_GET["id"])>0) {if ($row_liste_os['id_objectif_specifique']==$row_liste_iog['objectif_specifique']) {echo "SELECTED";}} elseif(!empty($id_os)) {if ($row_liste_os['id_objectif_specifique']==$id_os) {echo "SELECTED";}} ?>><?php echo $row_liste_os['intitule_objectif_specifique']; ?></option>
              <?php }}; ?>
            </select>
          </div>
        </div>      </td>
    ...
    <tr valign="top">
      <td colspan="3">
        <div class="form-group">
          ...
          <div class="col-md-9">
            <textarea class="form-control required" name="nom" id="nom" cols="25" rows="3"><?php if(isset($_GET["id"]) && intval($_GET["id"])>0) echo $row_liste_iog['intitule_indicateur_objectif_specifique']; ?></textarea>
          </div>
        </div>      </td>
    </tr>
