...
//Nombre d'activités
//if(isset($nb_code[0])){
  $query_liste_actpa = "SELECT count(distinct col18) as nb_bene, SUM(if(col6 = 'Homme', 1, 0)) as nb_h, SUM(if(col6 = 'Femme', 1, 0)) as nb_f, SUM(if(col14= 'Oui', 1, 0)) as nb_contrat, SUM(if(col7>15 && col7<46, 1, 0)) as nb_j, Login FROM t_1646217521 group by Login";
try{
...
-->
	...
	<table class="table table-striped table-hover" id="mtable">
      <thead>
        <tr>
          <th colspan="8"><div align="center">Nombre de PEI par animateur et par sexe </div></th>
        </tr>
        <tr>
          <th>&nbsp;</th>
