...
{
  $id=intval($_GET["id"]);
  $query_liste_src = "SELECT * FROM source_res WHERE id_source=$id ";
...
<div class="widget-header"> <h4><i class="icon-reorder"></i> <?php echo (isset($_GET["id"]) && intval($_GET["id"])>0)?"Modification":"Nouvelle"; echo " Source";?></h4> </div>
...
get_content('menu_effet.php','id=<?php echo $id_cp.'&id_s='.((isset($row_liste_src["resultat"]))?$row_liste_src["resultat"]:$id_os); ?>','resultat','');
</script>
