...
///////////////////////////////////////////////
  ...
  if(isset($_POST['identifiant']) && isset($_POST['password']))
  {
    ...
    $query_clp = "SELECT P.*, U.nom_ugl as nom_structure, U.code_ugl as code_structure, U.abrege_ugl as sigle FROM ".$database_connect_prefix."personnel P, ".$database_connect_prefix."ugl U WHERE P.id_personnel="."'$l' AND P.pass="."'$p' and P.structure=U.code_ugl";
    try{
