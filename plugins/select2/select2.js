    ...
    if (window.Select2 === b) {
        ...
        j = a(document), g = function() {
            ...
            formatInputTooShort: function(a, b) {
                var c = b - a.length;
                return "Veuillez saisir " + c + " plus de caract&egrave;re" + (1 == c ? "" : "s")
            },
            formatInputTooLong: function(a, b) {
                var c = a.length - b;
                return "Veuillez supprimer " + c + " caract&egrave;re" + (1 == c ? "" : "s")
            },
            formatSelectionTooBig: function(a) {
                return "Vous pouvez selectionnez " + a + " &eacute;l&eacute;ment" + (1 == a ? "" : "s")
            },
            formatLoadMore: function() {
                return "Chargement des r&eacute;sultats..."
            },
