...
(function(b){var c=/wysiwyg-family-[a-z]+/g;b.commands.fontFamily={exec:function(a,d,e){return b.commands.formatInline.exec(a,d,"span","wysiwyg-family-"+e,c)},state:function(a,d,e){return b.commands.formatInline.state(a,d,"span","wysiwyg-family-"+e,c)},value:function(){}}})(wysihtml5);
(function(b) {var undef;b.commands.customSpan = {exec: function(composer, command, sty) {return b.commands.formatInline.exec(composer, 'insertHTML', "span", sty, new RegExp(sty));},state: function(composer, command, sty) {return b.commands.formatInline.state(composer, 'insertHTML', "span", sty, new RegExp(sty));},value: function() {return undef;}};})(wysihtml5);
