...
$dir = (isset($_GET["dir"]))?$_GET["dir"]:'./attachment/dano/';
...
$dir = $chemin_dir = $d.$a[$i];
if(substr($dir,-1,1)!='/') $dir = $chemin_dir = $dir.'/';
      ...
      <td valign="middle">
        <div class="form-group">
          ...
          <div class="col-md-6">
            ...
            <span class="help-block h0" id="code_zone_text">Chemin : <?php echo $chemin_dir; ?></span>
          </div>
        </div>
      </td>
    </tr>
